...
def load_experiment_metadata(
    ...
    return {"metadata": metadata, "config": base_config, "seeds": metadata["seeds"]}
...
def plot_ood_results(
    ...
    for _, seed_errors in results["results"].items():
...
if __name__ == "__main__":
    ...
    experiment_dir = (
        "logs/experiments/expt_20250912_023600"  # Replace with your experiment
    )
